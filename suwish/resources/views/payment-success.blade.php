...
<head>
    ...
    <title>Payment Successful - Suwish</title>
        ...
        <div class="max-w-md w-full space-y-8 bg-white p-8 rounded-lg shadow-lg">
            <div class="text-center">
                ...
                <div class="mt-6 bg-gray-50 p-4 rounded-md">
                    ...
                    <p class="text-sm text-gray-600 mt-1">Payment Status: <span class="text-green-600 font-medium">{{ $order->payment_status ?? 'N/A' }}</span></p>
                </div>
