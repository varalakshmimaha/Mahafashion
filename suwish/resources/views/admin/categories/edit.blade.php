            ...
            <div class="p-6 space-y-6">
                ...
                <div>
                    ...
                    <textarea id="description" 
                              name="description" 
                              rows="3" 
                              class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition duration-300">{{ old('description', $category->description) }}</textarea>
                    @error('description')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div>
                    ...
                    <div class="flex items-center gap-4">
                        <div class="flex-shrink-0">
                            <img id="imagePreview" 
                                 src="{{ $category->image_url ? $category->image_url : 'https://via.placeholder.com/150x150/cccccc/666666?text=Upload+Image' }}" 
                                 alt="Current Image" 
                        ...
                        <div class="flex-1">
                            ...
                            @if($category->image)
                                <p class="mt-1 text-xs text-gray-500">Current image: {{ basename($category->image) }}</p>
                            @endif
                        </div>
                    </div>
                    @error('image')
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <textarea id="meta_description" 
                                  ...
                                  rows="2" 
                                  class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition duration-300">{{ old('meta_description', $category->meta_description) }}</textarea>
